...
class MainActivityViewModel: ViewModel() {
	...
	// Vehicle to hold
	internal val vehicle = mutableStateOf(Vehicle(2002, "Ford", "Ranger", 12000.9, "My Comments", 1, 3))
	private var backupVehicle = Vehicle(2022, "Toyota", "Tacoma", 10.0, "My NEW CAR!!", 3, 4)
